...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--img_in_dir', default=r'../datasets/self/IR/', type=str,
    ...
    parser.add_argument('-t', '--txt_out_path',
                        default=r'/data/tomzhai/face_align/datasets/training_materials/txt/self_labels.txt', type=str,
                        help='folder dir to output image')
